CREATE OR REPLACE TABLE `bigquery-tutorial-480009.A2.Fact_Glucose_PP`
(
  -- Foreign Keys
  ...
  -- Glucose PP Facts (Measures)
  Postprandial_Glucose INT64 NOT NULL
)
AS
SELECT
  ...
  -- GLUCOSE PP FACTS (Measures)
  COALESCE(f.`Postprandial Glucose _mg_dL_`, 0) AS Postprandial_Glucose
