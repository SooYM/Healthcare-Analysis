CREATE OR REPLACE TABLE `bigquery-tutorial-480009.A2.Fact_Glucose_Fasting`
(
  -- Foreign Keys
  ...
  -- Glucose Fasting Facts (Measures)
  Fasting_Glucose INT64 NOT NULL
)
AS
SELECT
  ...
  -- GLUCOSE FASTING FACTS (Measures)
  COALESCE(f.`Fasting Glucose _mg_dL_`, 0) AS Fasting_Glucose
