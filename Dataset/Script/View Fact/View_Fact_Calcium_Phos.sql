CREATE OR REPLACE VIEW `bigquery-tutorial-480009.A2.View_Fact_Calcium_Phos` AS
SELECT 
  -- Standard Dimensions
  ...
  -- Metrics: Mineral Levels
  IFNULL(F.Calcium, 0.0) AS Calcium,
  IFNULL(F.Phosphorus, 0.0) AS Phosphorus

FROM `bigquery-tutorial-480009.A2.Fact_Calcium_Phos` F
